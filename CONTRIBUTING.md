...
| `$ make container` | Build the container image (`extension-cloudfoundry:latest`) using Docker buildx.                      |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-cloudfoundry/Chart.yaml)
...
```
> Releasing charts...
    Error: error creating GitHub release steadybit-extension-cloudfoundry-1.0.0: POST https://api.github.com/repos/steadybit/extension-cloudfoundry/releases: 422 Validation Failed [{Resource:Release Field:tag_name Code:already_exists Message:}]
```
